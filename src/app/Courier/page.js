"use client"
import { FaTruck, FaPlane, FaShippingFast } from "react-icons/fa"
...
export default function EducationCategories() {
    const courierCategories = [
        { name: "Courier Services", icon: <MdOutlineLocalShipping className="w-5 h-5" /> },
        { name: "International Courier Services", icon: <FaPlane className="w-5 h-5" /> },
        { name: "Domestic Courier Services", icon: <FaShippingFast className="w-5 h-5" /> },
        { name: "Courier Services For All India", icon: <GiDeliveryDrone className="w-5 h-5" /> },
        { name: "Bulk Courier Services", icon: <FaTruck className="w-5 h-5" /> },
    ]
        ...
        <>
            ...
            <div className="max-w-2xl mx-auto mt-6 p-4 ">
                ...
                <div className="space-y-3">
                    {courierCategories?.map((cat, index) => (
                        <div
                            key={index}
